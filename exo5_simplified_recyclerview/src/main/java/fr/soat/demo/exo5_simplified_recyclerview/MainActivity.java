...
public class MainActivity extends AppCompatActivity implements FilterListener {
    ...
    // TODO Pass this boolean to "true" when RecyclerView with binding is ready
    ...
    private List<BindableViewModel> createMovieSeriesViewModels(List<MovieSeriesModel> listMovieSeries){
        ...
        // TODO create a list similar to the one created by the method "createMovieSeriesItems", except that in place of MovieSeriesItems we use directly implementations of BindableViewModel
